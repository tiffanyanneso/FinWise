 ...
 * Use the [AssessmentPerformanceFragment.newInstance] factory method to
...
class AssessmentPerformanceFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment AssessmentPerformanceFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            AssessmentPerformanceFragment().apply {
