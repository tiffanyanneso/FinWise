 ...
 * Use the [AssessmentLeaderboardFragment.newInstance] factory method to
...
class AssessmentLeaderboardFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment AssessmentLeaderboardFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            AssessmentLeaderboardFragment().apply {
