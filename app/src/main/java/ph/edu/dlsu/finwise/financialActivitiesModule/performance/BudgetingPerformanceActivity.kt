...
class BudgetingPerformanceActivity : AppCompatActivity() {
    ...
    private fun setParentalInvolvement() {
        ...
        if (parentalPercentage < 5) {
            ...
            audio = R.raw.budgeting_performance_parental_involvement_amazing
            ...
            audio = R.raw.budgeting_performance_parental_involvement_good
            ...
            audio = R.raw.budgeting_performance_parental_involvement_average
    ...
    private fun setBudgetAccuracy() {
        ...
        if (purchasedBudgetItemCount!=0.0F) {
            ...
            if (budgetAccuracy >= 96) {
                audio = R.raw.budgeting_performance_accuracy_excellent
                ...
                audio = R.raw.budgeting_performance_accuracy_amazing
                ...
                audio = R.raw.budgeting_performance_accuracy_great
                ...
                audio = R.raw.budgeting_performance_accuracy_good
                ...
                audio = R.raw.budgeting_performance_accuracy_average
                ...
                audio = R.raw.budgeting_performance_accuracy_getting_there
                ...
                audio = R.raw.budgeting_performance_accuracy_not_quite_there_yet
            ...
            audio = R.raw.budgeting_performance_accuracy_default
            binding.tvBudgetAccuracyText.text =
    ...
    private fun setOverall() {
        ...
        if (overall >= 96) {
            ...
            audio = R.raw.budgeting_performance_overall_needs_improvement
    ...
    private fun showBudgetAccuracyAmountReivewDialog() {
        ...
        //TODO: Change audio and dialogBinding
        var audio = R.raw.dialog_budget_accuracy_amount_review
