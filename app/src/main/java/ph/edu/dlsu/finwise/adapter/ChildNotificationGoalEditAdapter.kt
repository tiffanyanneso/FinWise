...
class ChildNotificationGoalEditAdapter : RecyclerView.Adapter<ChildNotificationGoalEditAdapter.ChildNotificationGoalEditViewHolder>{
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): ChildNotificationGoalEditAdapter.ChildNotificationGoalEditViewHolder {
        val itemBinding = ItemNotifGoalApprovedBinding
            .inflate(
                LayoutInflater.from(parent.context),
                parent, false)
        return ChildNotificationGoalEditViewHolder(itemBinding)
    }

    override fun onBindViewHolder(holder: ChildNotificationGoalEditAdapter.ChildNotificationGoalEditViewHolder,
                                  position: Int) {
