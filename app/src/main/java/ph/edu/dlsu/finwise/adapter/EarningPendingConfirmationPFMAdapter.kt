...
import ph.edu.dlsu.finwise.parentFinancialManagementModule.EarningSendMoneyActivityPFM
import java.text.DecimalFormat

class EarningPendingConfirmationPFMAdapter : RecyclerView.Adapter<EarningPendingConfirmationPFMAdapter.EarningCompletedViewHolder>{
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): EarningPendingConfirmationPFMAdapter.EarningCompletedViewHolder {
    ...
    override fun onBindViewHolder(holder: EarningPendingConfirmationPFMAdapter.EarningCompletedViewHolder,
                                  position: Int) {
    ...
    inner class EarningCompletedViewHolder(private val itemBinding: ItemEarningPendingConfirmationBinding) : RecyclerView.ViewHolder(itemBinding.root), View.OnClickListener {
        ...
        override fun onClick(p0: View?) {
            var confirm = Intent (context, EarningSendMoneyActivityPFM::class.java)
            var bundle = Bundle()
