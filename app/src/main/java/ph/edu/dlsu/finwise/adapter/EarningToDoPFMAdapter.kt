...
class EarningToDoPFMAdapter : RecyclerView.Adapter<EarningToDoPFMAdapter.EarningToDoViewHolder> {
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): EarningToDoPFMAdapter.EarningToDoViewHolder {
    ...
    override fun onBindViewHolder(holder: EarningToDoPFMAdapter.EarningToDoViewHolder, position: Int) {
