            ...
            if (nRatings!=0) {
                ...
                if (percentage >= 96) {
                    ...
                    binding.tvPerformanceText.text =
                        "Keep up the excellent work! Goal Setting is your strong point. Keep setting those goals!"
                    showSeeMoreButton()
                    ...
                    binding.tvPerformanceText.text =
                        "Amazing job! You are performing well. Goal Setting is your strong point. Keep setting those goals!"
                    showSeeMoreButton()
                    ...
                    binding.tvPerformanceStatus.setTextColor(getResources().getColor(R.color.green))
                    binding.tvPerformanceText.text =
                        "Great job! You are performing well. Keep setting those goals!"
                    showSeeMoreButton()
                    ...
                    binding.tvPerformanceText.text =
                        "Nice work! Work on improving your goal setting performance. Review SMART Goals!"
                    showReviewButton()
                    ...
                    binding.tvPerformanceStatus.setTextColor(getResources().getColor(R.color.red))
                    binding.tvPerformanceText.text =
                        "Almost there! You need to work on your goal setting. Click review to learn how!"
                    showReviewButton()
                    ...
                    binding.tvPerformanceStatus.setTextColor(getResources().getColor(R.color.red))
                    binding.tvPerformanceText.text =
                        "Getting there! You need to work on your goal setting. Click review to learn how!"
                    showReviewButton()
                    ...
                    binding.tvPerformanceStatus.setTextColor(getResources().getColor(R.color.red))
                    binding.tvPerformanceText.text =
                        "Uh oh! You need to work on your goal setting. Click review to learn how!"
                    showReviewButton()
                }
