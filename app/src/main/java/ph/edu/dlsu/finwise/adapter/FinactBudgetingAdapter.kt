...
class FinactBudgetingAdapter : RecyclerView.Adapter<FinactBudgetingAdapter.FinactBudgetingViewHolder>{
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): FinactBudgetingAdapter.FinactBudgetingViewHolder {
        val itemBinding = ItemFinactBudgetingBinding
            .inflate(
                LayoutInflater.from(parent.context),
                parent, false)
        return FinactBudgetingViewHolder(itemBinding)
    }

    override fun onBindViewHolder(holder: FinactBudgetingAdapter.FinactBudgetingViewHolder,
                                  position: Int) {
        holder.bindGoal(goalsIDArrayList[position])
    }

    inner class FinactBudgetingViewHolder(private val itemBinding: ItemFinactBudgetingBinding) : RecyclerView.ViewHolder(itemBinding.root), View.OnClickListener {
