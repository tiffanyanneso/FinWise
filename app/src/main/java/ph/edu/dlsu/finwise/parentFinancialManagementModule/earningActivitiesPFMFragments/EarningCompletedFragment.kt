...
class EarningCompletedPFMFragment : Fragment() {
    ...
    private fun getCompletedEarning() {
        ...
        firestore.collection("EarningActivities").whereEqualTo("childID", childID).whereEqualTo("source", "PFM").whereEqualTo("status", "Completed").get().addOnSuccessListener { results ->
